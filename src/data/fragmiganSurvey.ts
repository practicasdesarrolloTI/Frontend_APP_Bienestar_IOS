export const framinghamSurvey = {
  ...
  recomendaciones: [
    { min: -2, max:4, texto: '¡Vas muy bien!. Mantente alerta, pero no es necesario realizar pruebas en este momento. Lleva un estilo de vida saludable: evita el humo del cigarrillo y cuida tu sistema respiratorio. Recuerda tener alguna actividad física como caminar o bailar y mantener una dieta saludable. Puedes repetir el cuestionario en el futuro si presentas síntomas como tos persistente o dificultad para respirar.', sexo: null },
    { min: 5, max: 10, texto: 'Hay algunos signos que vale la pena observar. Te sugerimos hablar con un médico para revisar tu salud respiratoria y posiblemente hacerte una prueba sencilla. Si fumas o consumes alcohol con frecuencia, podrías considerar dejarlo, y si no, ¡sigue así! Pequeños cambios pueden hacer una gran diferencia. Recuerda mantenerte activo y seguir una dieta baja en sodio y grasas saturadas.', sexo: null },
    { min: 11, max: 30, texto: 'Tus respuestas muestran señales que podrían indicar algún problema respiratorio. No te preocupes, pero sí te recomendamos pedir una cita médica pronto. Un chequeo y algunos cuidados pueden ayudarte a respirar con más facilidad y tener una mejor calidad de vida. ¡Estás a tiempo!', sexo: null },
  ],
};
